...
exports._authPost = authRequest('_post', true);
exports._authPatch = authRequest('_patch', true);
exports._authDelete = authRequest('_delete');
exports._authGet = authRequest('_get');

exports._post = request('post', true);
exports._patch = request('patch', true);
exports._get = request('get');
exports._delete = request('del');
...
exports.buildPath = function (name, params) {
  var path = paths[name],
      re = /\/:([a-zA-Z0-9]+)/,
      result;
