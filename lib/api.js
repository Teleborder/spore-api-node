...
exports.authPost = authRequest('_post', true);
exports.authPatch = authRequest('_patch', true);
exports.authDelete = authRequest('_delete');
exports.authGet = authRequest('_get');
